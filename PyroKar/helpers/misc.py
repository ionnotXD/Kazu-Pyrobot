...
GIT_TOKEN = "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"
REPO_URL = "https://github.com/ionnotXD/PyroZu-Userbot"
...
async def create_botlog(client):
    ...
    try:
        gruplog = await client.create_supergroup("PyroZu UserBot", desc)
        if await in_heroku():
